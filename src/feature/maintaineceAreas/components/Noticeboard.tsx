...
export const Noticeboard = ({item}: {item:any})=>
{
    ...
    <Modal
        ...
        onTouchCancel={()=>handleCloseModal}
        // style={{height:200, backgroundColor:'red',flex:1}}
      >
        <View style={{justifyContent:'center',alignSelf:'center', position:'absolute',bottom:'40%',backgroundColor:'#fff',width:'60%',elevation:9,borderRadius:9,borderWidth:1,borderColor:'#06B8C3'}}>
        ...
        <View style={styles.modalContainer}>
          ...
          <TouchableOpacity style={styles.option} onPress={handleCloseModal}>
            {/* <Image source={require('../../../assets/png/edit.png')} style={styles.optionIcon} /> */}
